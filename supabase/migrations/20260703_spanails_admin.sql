...
insert into spanails.categorias (nombre, slug, descripcion, imagen_url, icono, orden, activo) values
  ...
  ('Uñas esculpidas',       'unas-esculpidas',       'Extensiones acrílicas o soft gel personalizadas.',                 '/unas-esculpidas.jpg',       'brush',      3, true),
...
values
  -- Manicura clásica
  ((select id from c where slug='manicura-clasica'), 'Manicura clásica',                    'manicura-clasica-servicio',       'Corte, limado, cutícula y esmaltado tradicional.',                        45,  50000,  null, false, false, '/manicura-clasica.jpg',      1, true),
  ((select id from c where slug='manicura-clasica'), 'Manicura express',                    'manicura-express',                'Retoque rápido de forma y esmaltado.',                                    25,  35000,  null, false, false, '/manicura-clasica.jpg',      2, true),
  ((select id from c where slug='manicura-clasica'), 'Manicura premium con hidratación',    'manicura-premium-hidratacion',    'Manicura completa con mascarilla hidratante y masaje.',                   60,  80000,  null, false, true,  '/manicura-clasica.jpg',      3, true),

  -- Semipermanentes
  ((select id from c where slug='unas-semipermanentes'), 'Esmaltado semipermanente',            'esmaltado-semipermanente',        'Esmaltado semipermanente de larga duración.',                             60,  90000,  null, false, true,  '/unas-semipermanentes.jpg',  1, true),
  ((select id from c where slug='unas-semipermanentes'), 'Semipermanente con diseño simple',    'semipermanente-diseno-simple',    'Semipermanente con detalles decorativos simples.',                        75, 110000,  null, false, false, '/unas-semipermanentes.jpg',  2, true),
  ((select id from c where slug='unas-semipermanentes'), 'Semipermanente con nail art',         'semipermanente-con-nail-art',     'Semipermanente con nail art personalizado.',                              90, 140000,  null, false, false, '/semi-nailart.jpg',          3, true),

  -- Esculpidas
  ((select id from c where slug='unas-esculpidas'), 'Uñas acrílicas',                       'unas-acrilicas',                  'Extensiones esculpidas en acrílico.',                                     120, 180000,  null, true,  true,  '/unas-esculpidas.jpg',       1, true),
  ((select id from c where slug='unas-esculpidas'), 'Uñas soft gel',                        'unas-soft-gel',                   'Extensiones en soft gel, ligeras y naturales.',                           120, 200000,  null, true,  false, '/unas-esculpidas.jpg',       2, true),
  ((select id from c where slug='unas-esculpidas'), 'Relleno de uñas',                      'relleno-unas',                    'Relleno y mantenimiento de esculpidas.',                                   90, 120000,  null, true,  false, '/unas-esculpidas.jpg',       3, true),
  ((select id from c where slug='unas-esculpidas'), 'Retiro de uñas',                       'retiro-unas',                     'Retiro seguro de esculpidas y acondicionamiento.',                         45,  50000,  null, false, false, '/unas-esculpidas.jpg',       4, true),

  -- Kapping
  ((select id from c where slug='kapping-gel'), 'Kapping gel',                          'kapping-gel-servicio',            'Refuerzo natural con gel sobre uña propia.',                              75, 120000,  null, false, false, '/kapping-gel.jpg',           1, true),
  ((select id from c where slug='kapping-gel'), 'Kapping con diseño',                   'kapping-con-diseno',              'Kapping gel con diseño decorativo.',                                      90, 150000,  null, false, false, '/kapping-gel.jpg',           2, true),

  -- Spa
  ((select id from c where slug='spa-manos'), 'Spa de manos',                         'spa-de-manos',                    'Ritual completo de hidratación, exfoliación y masaje de manos.',          45,  70000,  null, false, false, '/spa-manos.jpg',             1, true),
  ((select id from c where slug='spa-pies'),  'Spa de pies',                          'spa-de-pies',                     'Baño relajante, exfoliación y masaje de pies.',                            60,  90000,  null, false, false, '/spa-pies.jpg',              1, true),

// Catálogo integral de Mabel Beauty & Spa.
...
export const catalogo = [
  {
    ...
    grupos: [
      { titulo: 'Limpiezas faciales', servicios: ['Limpieza facial básica', 'Limpieza facial profunda', 'Limpieza ultrasónica', 'Limpieza con punta de diamante', 'Limpieza con espátula ultrasónica', 'Higiene facial para piel grasa', 'Higiene facial para piel seca', 'Higiene facial para piel sensible', 'Higiene facial masculina', 'Limpieza para adolescentes'] },
      { titulo: 'Tratamientos hidratantes', servicios: ['Hidratación profunda', 'Nutrición facial', 'Oxigenoterapia', 'Tratamiento calmante', 'Tratamiento reparador', 'Mascarillas profesionales'] },
      { titulo: 'Antiedad', servicios: ['Rejuvenecimiento facial', 'Lifting facial sin cirugía', 'Radiofrecuencia facial', 'HIFU', 'Microneedling (Dermapen)', 'Mesoterapia virtual', 'Electroporación', 'Colágeno facial', 'Elastina', 'Fototerapia LED', 'Terapia con oxígeno'] },
      { titulo: 'Manchas', servicios: ['Tratamiento despigmentante', 'Melasma', 'Manchas solares', 'Manchas postacné', 'Peelings despigmentantes'] },
      { titulo: 'Acné', servicios: ['Tratamiento antiacné', 'Control de sebo', 'Reducción de poros', 'Tratamiento para cicatrices'] },
